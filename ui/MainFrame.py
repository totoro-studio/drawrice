...
#
# Created: Tue Aug 19 21:18:31 2014
...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.push_Button_ImportAll = QtWidgets.QPushButton(Form)
        self.push_Button_ImportAll.setGeometry(QtCore.QRect(70, 310, 91, 23))
        self.push_Button_ImportAll.setObjectName("push_Button_ImportAll")
        ...
        self.push_Button_ImportAll.clicked.connect(Form.importall)
    ...
    def retranslateUi(self, Form):
        ...
        self.push_Button_ImportAll.setText(_translate("Form", "导入All"))
        ...
        self.label_statistic1.setText(_translate("Form", "TextLabel"))
        self.label_statistic2.setText(_translate("Form", "TextLabel"))
        self.label_statistic3.setText(_translate("Form", "TextLabel"))
        self.label_statistic4.setText(_translate("Form", "TextLabel"))
        self.label_statistic5.setText(_translate("Form", "TextLabel"))
        self.label_statistic6.setText(_translate("Form", "TextLabel"))
